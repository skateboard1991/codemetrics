...
import com.skateboard.codemetrics.checker.KtExpressionChecker
    ...
    override fun buildVisitor(
        ...
        return object : KotlinRecursiveElementWalkingVisitor() {
            override fun visitNamedFunction(function: KtNamedFunction) {
                var nodeNum = 0
                val ktExpressionChecker = KtExpressionChecker()
                ...
                if (nodeNum + 1 > complexLevel) {
                    holder.registerProblem(
                        ...
                        "圈复杂度（${nodeNum}），兄弟，注意一下", ProblemHighlightType.GENERIC_ERROR_OR_WARNING
                    )
                }
            }
